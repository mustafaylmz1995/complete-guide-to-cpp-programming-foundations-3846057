...
/*
    Expression:
    Bir işlem olması gerekir,
    bir sonuç üretmesi gerekir 
    operator variable constant gibi şeyler içerebilir

    Assignment
    Bir değer atayan kod satırıdır
    sol tarafı veri tutacak olmalı ve sağ tarafında expression olmalıdır
